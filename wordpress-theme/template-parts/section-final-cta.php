    ...
    <div class="container" style="position: relative; z-index: 10;">
        <div class="max-w-4xl">
            <div class="text-center mb-12">
                ...
                <p style="font-size: 1.5rem; color: hsl(var(--color-muted-foreground)); margin-bottom: 1.5rem;">
                    Junte-se a mais de 600 mães que transformaram a experiência da amamentação
                </p>
            </div>

            <div style="background: hsl(var(--color-card)); border-radius: var(--radius-3xl); padding: 2rem; box-shadow: var(--shadow-soft); border: 2px solid hsl(var(--color-primary) / 0.2);">
                <div class="text-center mb-6">
                    ...
                    <div class="cta-benefits" style="display: flex; flex-direction: column; gap: 1rem; align-items: center; margin-bottom: 1rem;">
